    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="space-y-4">
          ...
          {/* Available Online Users (excluding those already in chats) */}
          ...
          {/* Show users in active chats */}
          {activeChattingUsers.size > 0 && (
            <div className="space-y-2">
              <h3 className="font-medium text-gray-700">Already Chatting:</h3>
              {Array.from(activeChattingUsers).map((username) => (
                <div
                  key={username}
                ...
                >
                  ...
                  <span className="text-xs text-green-600 ml-auto">✓ Active Chat</span>
                </div>
              ))}
            </div>
          )}
